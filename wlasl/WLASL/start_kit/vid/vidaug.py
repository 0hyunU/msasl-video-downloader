...
class VidAug():
    ...
    @staticmethod 
    def flip_vid_arr(vid_arr):

        return np.flip(vid_arr, 2)

    @staticmethod
    def rotate_vid_arr(vid_arr):
